...
# Known Issues
  msr-tools issue with more than 255 CPUs
  ras/mce_mca tests will fail if it runs on a system with more than 255 CPUs. The issue is with 'msr-tools' installed from linux distribution.
  The issue is fixed in upstream 'msr-tools'. It is recommended to install upstream 'msr-tools' tool to get ras/mce_mca tests runs successfully.
        ...
        Steps to build and install upstream 'msr-tools' on Ubuntu 24.04:
